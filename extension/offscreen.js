...
async function startRecording(streamId) {
  ...
  try {
    ...
    //
        ...
        fetch('http://localhost:5000/upload-audio', { // <-- Zmień na właściwy adres endpointu
            method: 'POST',
            body: formData
          })
          .then(response => {
            ...
            return response.json(); // Lub inny odpowiedni format odpowiedzi
          })
          .then(data => {
            console.log('Upload successful:', data);
            // Możesz tutaj wyświetlić komunikat o powodzeniu w popupie
          ...
          .catch(error => {
            ...
            chrome.runtime.sendMessage({
                type: "upload-failed",
                target: "popup",
                message: "Audio upload failed: " + error.message
              });
            });
